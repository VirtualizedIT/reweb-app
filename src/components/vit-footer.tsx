        ...
        <div className="grid p-2 grid-cols-1 grid-rows-3 gap-2 sm:grid-cols-3 sm:grid-rows-1">
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-2.5">
              <a href="https://www.facebook.com/virtualizedit" className="text-background hover:text-accent">
              ...
              <a href="https://instagram.com/virtualizedit" className="text-background hover:text-accent">
                <svg width={100} height={100} viewBox="0 0 24 24" className="size-6">
                  <path
              ...
              <a href="https://x.com/Virtualized_IT" className="text-background hover:text-accent">
                <svg width={100} height={100} viewBox="0 0 24 24" className="size-6">
                  <path
              ...
              <a  href="https://linkedin.com/company/virtualizedit" className="text-background hover:text-accent">
                <svg width={100} height={100} viewBox="0 0 24 24" className="size-6">
                  <path
              ...
              <a href="https://www.youtube.com/@Virtualized_IT" className="text-background hover:text-accent">
                <svg
                  width={100}
                  height={100}
                  viewBox="0 0 30 20
